      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        <div className="space-y-6 text-gray-700 leading-relaxed">
          ...
          <div className="flex items-start">
            <span className="text-gray-900 font-bold mr-3 mt-1">•</span>
            <p className="text-base">
              Autotrader New York helps merchants conduct cross-border transactions, providing a system mechanism for greater mobility and faster transactions.
            </p>
          </div>
          ...
          <div className="flex items-start">
            <span className="text-gray-900 font-bold mr-3 mt-1">•</span>
            <p className="text-base">
              By displaying real user reviews, Autotrader New York helps brands build trust and improve potential customers' purchasing decisions.
            </p>
          </div>
          ...
          <div className="flex items-start">
            <span className="text-gray-900 font-bold mr-3 mt-1">•</span>
            <p className="text-base">
              Autotrader New York can be integrated with agencies and marketing tools in different countries to help brands manage customer transactions in cross-border channels.
            </p>
          </div>
